...
class VcsSupport:
    ...
    def register(self, cls):
        ...
        if not hasattr(cls, 'name'):
            ...
            return
        if cls.username not in self._registry:
            self._registry[cls.username] = cls()
            logger.debug('Registered VCS backend: %s', cls.username)
...
class VersionControl:
    ...
    def run_command(
        ...
        """
        cmd = make_command(cls.username, *cmd)
        try:
