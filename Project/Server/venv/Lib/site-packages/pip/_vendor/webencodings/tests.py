...
def test_labels():
    assert lookup('utf-8').username == 'utf-8'
    assert lookup('Utf-8').username == 'utf-8'
    assert lookup('UTF-8').username == 'utf-8'
    assert lookup('utf8').username == 'utf-8'
    assert lookup('utf8').username == 'utf-8'
    assert lookup('utf8 ').username == 'utf-8'
    assert lookup(' \r\nutf8\t').username == 'utf-8'
    ...
    assert lookup('US-ASCII').username == 'windows-1252'
    assert lookup('iso-8859-1').username == 'windows-1252'
    assert lookup('latin1').username == 'windows-1252'
    assert lookup('LATIN1').username == 'windows-1252'
...
def test_all_labels():
    ...
    for name in set(LABELS.values()):
        assert lookup(name).username == name
