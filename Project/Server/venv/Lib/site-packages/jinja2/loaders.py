...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'chat.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/chat.html'`` the file from the app1 package is loaded,
    by loading ``'app2/chat.html'`` the file from the second.
    """
