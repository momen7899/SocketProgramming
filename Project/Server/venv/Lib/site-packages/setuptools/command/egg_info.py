...
class egg_info(InfoCommon, Command):
    ...
    def run(self):
        ...
        for ep in iter_entry_points('egg_info.writers'):
            ...
            writer = ep.resolve()
            writer(self, ep.username, os.path.join(self.egg_info, ep.username))
...
def write_pkg_info(cmd, basename, filename):
    ...
    if not cmd.dry_run:
        ...
        metadata.username, oldname = cmd.egg_name, metadata.username
        ...
        try:
            ...
            metadata.username, metadata.version = oldname, oldver
